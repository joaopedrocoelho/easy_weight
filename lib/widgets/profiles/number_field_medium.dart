...
class NeuNumberFieldMedium extends StatefulWidget {
  ...
  @override
  _NeuNumberFieldMediumState createState() => _NeuNumberFieldMediumState();
}

class _NeuNumberFieldMediumState extends State<NeuNumberFieldMedium> {
